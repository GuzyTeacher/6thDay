...
mainMenuLevel.wallPanels.push(new wordWall(750,560, 'BY ADAM GUZY',5));
	...
	leftSlide.job = function(){
		if(selEdit == 1){
			...
			for(var i=0; i < bOptions.length; i++)	bOptions[i].b.x -= 50
		}
	}
			...
			if(this.ty != this.gy){
				for(var i =0; i < creature.length; i++){
					if(Math.abs(creature[i].x + 100 - this.tx - 50) < 70 && Math.abs(creature[i].y + 200 - this.ty) < 20 ) {
						...
						else if(creature[i].x+100 > this.tx + 100) creature[i].x = this.tx
					}
	...
	//	paray = (creature[0].y - h/2)*0.1 + ctxOy*5
		...
		*/
		...
		ctx.fillText("Health: ", 10, h - 110);
		ctx.fillStyle = '#DD0000'
		ctx.fillRect(78, h - 122, 204, 14);
		ctx.fillStyle = '#FF0000'
		ctx.fillRect(80, h - 120, 200 * creature[cS].stats.health/creature[cS].stats.maxHealth, 10);
		
		ctx.fillStyle = 'white'
		ctx.fillText("Level: " + creature[cS].level, 10, h - 90);
		ctx.fillStyle = '#00DDDD'
		ctx.fillRect(78, h - 102, 204, 14);
		ctx.fillStyle = '#00FFFF'
		ctx.fillRect(80, h - 100, 200 * creature[cS].exp/(creature[cS].level*10), 10);
		ctx.fillStyle = 'white'
		ctx.fillText(creature[cS].exp + " / " + creature[cS].level*10, 180 - ctx.measureText(creature[cS].exp + " / " + creature[cS].level*10).width / 2, h - 90);
		
		ctx.fillText(creature[cS].stats.health + " / " + creature[cS].stats.maxHealth, 180 - ctx.measureText(creature[cS].stats.health + " / " + creature[cS].stats.maxHealth).width / 2, h - 110);
		...
		//level maker
			...
			if(selEdit == 1){
				...
				ctx.fillText("Biological Objects", 20, h - 120);
...
cutscene[0].lev.wallPanels.push(new wordWall(410,270, 'EXAM',5));
	...
	function createCreature(a,b,c,d){
		...
		var result = {
			...
			sw:0,
			light:true,
			aimer:{x:a-200,y:b-100},
			taimer:{x:a - 200,y:b - 100},
			...
			draw:function(){
				...
				//fall
					...
					if(this.y > h*2 - 300) {//Stop falling at bottom of level
						this.sy = 0;
						this.y = h*2 - 300;
					}
				}
...
level[2].creature.push(Bug(1400,200,0));
level[2].items.push(armorItem(580,340));
level[2].items.push(smgItem(490,350));
level[2].items.push(smgItem(620,350));

level[2].creature.push(LowInsect(1260,190,0));
...
level[8].items.push(messageTrap(1590,210, blankPic, 'PLEASE!', "Don't shoot!~~ I'm like you!.. I mean I used to be. ~~My legs started to change, now theyre like this.  ~~Please don't leave here...  Please?"));
...
level[9].wallPanels.push(new ForeGround(830,1000, bioPic[7]));
level[9].wallPanels.push(new ForeGround(320,980, bioPic[9]));
level[9].wallPanels.push(new ForeGround(1000,910, bioPic[8]));
level[9].wallPanels.push(new ForeGround(590,900, bioPic[4]));
level[9].wallPanels.push(new ForeGround(100,1000, bioPic[7]));
level[9].wallPanels.push(new ForeGround(1800,1000, bioPic[6]));
level[9].wallPanels.push(new ForeGround(1500,900, bioPic[11]));
level[9].wallPanels.push(new ForeGround(1400,1010, bioPic[2]));
level[9].wallPanels.push(new ForeGround(1660,1010, bioPic[3]));
level[9].wallPanels.push(new ForeGround(1200,990, bioPic[1]));
level[9].wallPanels.push(new ForeGround(1140,900, bioPic[0]));
level[9].wallPanels.push(new ForeGround(960,990, bioPic[5]));
level[9].wallPanels.push(new ForeGround(300,990, bioPic[1]));
level[9].wallPanels.push(new ForeGround(430,890, bioPic[5]));
level[9].wallPanels.push(new ForeGround(640,860, bioPic[10]));
level[9].wallPanels.push(new ForeGround(760,900, bioPic[3]));
...
level[9].exits.push(new Exit(850,950, 7, true, 300,550))
...
draw: trash can
	...
	display for allied characters (top torso + hair? avoid all the rest or just miniturize the whole)
	
	button to transition from live game to editor and back again
	angle creatures that fly, allow extra horizontal speed while flying, make speed changes gradual for physics type movement
